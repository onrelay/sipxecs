...
classpath="symclient.jar:$COMMONS/log4j.jar:$COMMONS/dnsjava.jar:$COMMONS/commons-collections.jar:$COMMONS/commons-digester.jar:$COMMONS/commons-beanutils.jar:$COMMONS/xmlrpc-common.jar:$COMMONS/xmlrpc-server.jar:$COMMONS/xmlrpc-client.jar:$COMMONS/ws-commons-util.jar:$COMMONS/junit.jar:tools/sipunit.jar:lib/ice4j.jar:$COMMONS/sipxcommons.jar:./classes"

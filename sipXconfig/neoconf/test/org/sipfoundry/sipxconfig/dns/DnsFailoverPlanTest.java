...
public class DnsFailoverPlanTest {
    ...
    private Location m_s1Rnull= new Location("server-1-no-region", "1.1.1.0");
    private Location m_s2Rnull = new Location("server-2-no-region", "1.1.2.0");
    private Location m_s1R1 = new Location("server-1-region-1", "1.1.1.1");
    private Location m_s2R1 = new Location("server-2-region-1", "1.1.2.1");
    private Location m_s1R2 = new Location("server-1-region-2", "1.1.1.2");
    private Location m_s2R2 = new Location("server-2-region-2", "1.1.2.2");

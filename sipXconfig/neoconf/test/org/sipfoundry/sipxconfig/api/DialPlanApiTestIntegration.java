...
public class DialPlanApiTestIntegration extends RestApiIntegrationTestCase {
    ...
    public void testDialPlanJsonApi() throws Exception {
        ...
        assertEquals(
            ...
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(0).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(0).getStop().getTime(),
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(1).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(1).getStop().getTime(),
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(2).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(2).getStop().getTime(),
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(3).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(3).getStop().getTime(),
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(4).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(4).getStop().getTime(),
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(5).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(5).getStop().getTime(),
            ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(6).getStart().getTime(), ((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(6).getStop().getTime(),
            rules.get(7).getId()),
            rulesJson);
    ...
    public void testDialPlanXmlApi() throws Exception {
        ...
        assertEquals(
            ...
            rules.get(0).getId(), rules.get(1).getId(), rules.get(2).getId(), rules.get(3).getId(), rules.get(4).getId(), rules.get(5).getId(), rules.get(6).getId(),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(0).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(0).getStop()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(1).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(1).getStop()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(2).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(2).getStop()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(3).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(3).getStop()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(4).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(4).getStop()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(5).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(5).getStop()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(6).getStart()),
            dateFormat.format(((AttendantRule)rules.get(6)).getWorkingTimeAttendant().getWorkingHours().get(6).getStop()),
            rules.get(7).getId()),
            rulesXml);
        // create attendant dialing rule

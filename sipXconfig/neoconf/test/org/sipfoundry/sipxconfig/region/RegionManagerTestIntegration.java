...
public class RegionManagerTestIntegration extends IntegrationTestCase {
    ...
    public void testCrud() {
        ...
        r1.setAddresses(new String[] {"10.1.1.1/32"});
        ...
        String r1Expected = "Region[m_name=Bird Bath in Central Park,m_addresses={10.1.1.1/32},ID]";
        assertEquals(r1Expected, dump(regions));

        // Find
        Region r2 = new Region();
        String r2Expected = "Region[m_name=Statue of Liberty,m_addresses={10.1.1.0/24,10.1.2.0/24},ID]";
        r2.setName("Statue of Liberty");
        r2.setAddresses(new String[] {"10.1.1.0/24", "10.1.2.0/24"});
        ...
        assertEquals("Region[m_name=Nesting,m_addresses={10.1.1.1/32},ID]|" + r2Expected, actual);

...
public class SpecialAttendantResourceTest extends TestCase {
    ...
    public void testRepresentXml() throws Exception {
        SpecialAttendantResource resource = new SpecialAttendantResource();
        ...
        String expected = IOUtils.toString(getClass().getResourceAsStream("specialMode.rest.test.xml"));
    ...
    public void testRepresentJson() throws Exception {
        ...
        String generated = writer.toString();
        String expected = IOUtils.toString(getClass().getResourceAsStream("specialMode.rest.test.json"));
        assertEquals(expected, generated);
    }

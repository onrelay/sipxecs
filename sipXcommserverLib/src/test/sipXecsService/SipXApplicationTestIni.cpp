...
class SipXApplicationTestIni: public CppUnit::TestCase
{
  CPPUNIT_TEST_SUITE(SipXApplicationTestIni);
...
public:
  ...
  void createConfigFile(const std::string& configFilename)
  {
    ...
    {
      std::ofstream config(configFilename.c_str());
...
CPPUNIT_TEST_SUITE_REGISTRATION(SipXApplicationTestIni);

import { AbstractObservable, Monitor, Observation } from "@sipxdao/common";
import { DatabaseManager } from "./databaseManager";
import { DatabaseConverter } from "./databaseConverter";
import { CollectionDatabase } from "./collectionDatabase";
import { DatabaseDocument, EndDatePropertyKey } from "./databaseDocument";
...
import { ChangesCollection } from "./databaseService";
import { ChangeTypes } from "../types/changeType";
import { Entity } from "./entity";
import { Change, ChangeTypePropertyKey } from "./change";
import { DatabaseFilter } from "./databaseFilter";
import { Comparator, Comparators } from "../types/comparator";
...
export abstract class AbstractDatabaseManager extends AbstractObservable implements DatabaseManager {
    ...
    async createDocument( collectionDatabase : CollectionDatabase<DatabaseDocument>, databaseDocument : DatabaseDocument ): Promise<DatabaseDocument> {
        ...
        try {
            ...
            databaseDocument.lastChangedBy.setValue( authenticatedDatabaseEntity?.referenceHandle() as ReferenceHandle<Entity> );

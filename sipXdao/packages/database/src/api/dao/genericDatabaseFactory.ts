...
import { DatabaseDocument, DatabaseDocumentNameKey } from "./databaseDocument";
import { CollectionDatabase } from "./collectionDatabase";
import { CollectionGroupDatabaseImpl } from "../../internal/dao/collectionGroupDatabaseImpl";
import { CollectionDatabaseImpl } from "../../internal/dao/collectionDatabaseImpl";
import { log } from "./abstractDatabaseService";
import { Template } from "./template";
import { TemplatedDocument } from "./templatedDocument";
import { DatabaseFactory } from "./databaseFactory";
import { CollectionGroupPathSuffix, TemplatePathKey } from "./databaseService";
...
import { AbstractTemplatedDocument } from "./abstractTemplatedDocument";
import { DatabaseObserver } from "./databaseObserver";
import { DatabaseQuery } from "./databaseQuery";
import { DatabaseObserverImpl } from "../../internal/dao/databaseObserverImpl";
import { ReferenceHandle } from "./referenceHandle";
import { TemplatedProperties } from "./templatedProperties";
import { SubdocumentPropertyImpl } from "../../internal/properties/subdocumentPropertyImpl";
import { TemplatedPropertiesImpl } from "../../internal/dao/templatedPropertiesImpl";
import { PropertyDescriptorImpl } from "../../internal/dao/propertyDescriptorImpl";
...
export class GenericDatabaseFactory implements DatabaseFactory {
    ...
    constructor( configurationManager : ConfigurationManager, databaseManager : DatabaseManager ) {
        ...
        try {
            ...
            const collectionsConfig = configurationServiceFactory!.get().cached( "collections" ) as any;
            ...
            if( owner == null ) {
                ...
                if( collectionGroup == null ) {
                    ...
                    const collectionConfig = 
                        configurationServiceFactory!.get().cached( "collections", collectionName ) as any;
                ...
                if( collectionGroup == null ) {
                    ...
                    const collectionConfig = configurationServiceFactory!.get().cached( "collections", collectionName ) as any;

...
import { PropertyType, PropertyTypes } from "../types/propertyType";
import { DatabaseFilter } from "./databaseFilter";
import { Comparators } from "../types/comparator";
...
import { DatePropertyImpl } from "../../internal/properties/datePropertyImpl";
...
import { ChangesCollection, NewObjectId, OwnerIds } from "./databaseService";
...
import { ReferencePropertyImpl } from "../../internal/properties/referencePropertyImpl";
import { BooleanPropertyImpl } from "../../internal/properties/booleanPropertyImpl";
import { DatabaseDocumentNameKey } from "./databaseDocument";
import { KeysCollectionName } from "./key";
...
export class GenericDatabaseDocument extends AbstractDatabaseObject implements DatabaseDocument {
    ...
    constructor( documentName : string,
        ...
        try {
            ...
            this.lastChangedBy = new ReferencePropertyImpl<Entity>( this );
    ...
    readonly lastChangedBy : ReferenceProperty<Entity>;
